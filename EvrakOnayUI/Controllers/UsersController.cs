...
namespace EvrakOnayUI.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,Lastname,Email,Password,UserTypeId,Token,IsEmailValidated")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,Lastname,Email,Password,UserTypeId,Token,IsEmailValidated")] User user)
        {
            if (ModelState.IsValid)
            {
